...
export default function RoomPage() {
  ...
  // You can eventually replace this with real WS/game/cube/timer logic
  // For now, preserve extra UI/logic and roomId copy action, etc
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col items-center justify-center p-4 md:p-8 font-sans">
      {/* Simple logic UI block at the top, as in prompt */}
        ...
        <div className="text-center mb-6">
          ...
          <p className="mt-2 text-slate-300 text-lg">
            ...
            <button
              ...
              className="ml-3 p-1 bg-slate-800 border border-slate-700 rounded hover:bg-indigo-700 transition"
              title="Copy Room ID"
            >
              {isCopied ? (
          ...
          <p className="mt-6 text-base text-slate-400">
            Game UI comes here (WS, cube, timers...).
          </p>
          <button
            className="mt-6 underline text-slate-300"
            onClick={() => router.push("/")}
          >
            Go Home
          </button>
      ...
      {/* Main elaborate room UI as before */}
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center mb-12">
          ...
          <div className="text-center">
            <p className="text-4xl md:text-6xl font-black text-slate-600 animate-pulse">
              VS
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
            ...
            <p className="text-slate-400 mt-2">
              Both players are connected. Prepare for the match!
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <span className="ml-3 text-slate-300">
                  Solve the Rubik's Cube as fast as possible.
                </span>
              </li>
              <li className="flex items-center">
                <TrophyIcon />
                <span className="ml-3 text-slate-300">
                  The first player to solve wins the match.
                </span>
              </li>
              <li className="flex items-center">
                <ChartIcon />
                <span className="ml-3 text-slate-300">
                  Your rating will be updated based on the result.
                </span>
              </li>
            </ul>
          </div>
